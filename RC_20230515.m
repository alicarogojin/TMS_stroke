...
% Notch filter (1=on, 0=off)
notch_filter = 1;
notch_low = 57;
notch_high = 63;

% Bandpass Parameters
bandpass_low = 0; % Low pass
bandpass_high = 1000; % High pass
sample_rate = 5000;
...
% Apply notch filter
if notch_filter
    EEG = pop_eegfiltnew(EEG, 'locutoff', notch_low, 'hicutoff', notch_high, 'revfilt', 1);
end

% Apply bandpass filter
EEG = pop_eegfiltnew(EEG, 'locutoff', bandpass_low, 'hicutoff', bandpass_high);
